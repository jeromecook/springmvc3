...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<div class="fh5co-hero fh5co-hero-2">
			...
			<div class="fh5co-cover fh5co-cover_2 text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/service-1.jpg);">
			...
			<div class="container">
				<div class="row row-bottom-padded-lg">
					...
					<div class="col-md-8 col-md-push-1">
						...
						<ul>
							...
							<li>Marketing</li>
							<li>Staging</li>
							<li>ONE-Optimized Network Exposure </li>
						</ul>
					</div>
				</div>
				...
				<div class="row row-bottom-padded-lg">
					...
					<div class="col-md-7 col-md-pull-3">
						...
						<h2>NEGOTIATE</h2>
							...
							When you have a trained negotiator in your corner, the sales process is far less stressful.
							</p>
						<ul>
							<li>Your best interest</li>
							<li>Trust litigation</li>
							<li>Buyer/Seller contract</li>
							<li>Lease back</li>
						</ul>
					</div>
				</div>
				...
				<div class="row row-bottom-padded-lg">
					...
					<div class="col-md-8 col-md-push-1">
						...
						<h2>Buying</h2>
							...
							<ul>
							<li>New homes on the market</li>
							<li>Apprasil</li>
							<li>Private Viewing</li>
							<li>Negotiate your best price</li>
						</ul>
					</div>
				</div>
				...
				<div class="row row-bottom-padded-lg">
					...
					<div class="col-md-7 col-md-pull-3">
						...
						<p>Our specialty:
							      Start you own business with real estate. Become a landlord 10% ROI, Flipping Houses up 40% ROI.</p>
						<ul>
							<li>Investor/ Partial investor</li>
							<li>Flipping investments</li>
							<li>Rental investments</li>
							<li>Locating potential propeties</li>	
						</ul>
					</div>
				</div>
